...
//        pybinding to enum classes:
  ...
  py::enum_<ContactFormulation::Type>(m, "ContactFormulation")
		.value("Penalty", ContactFormulation::Penalty)    //existing penalty-based GeneralContact formulation
		.value("IPCBarrier", ContactFormulation::IPCBarrier)    //placeholder for IPC-style barrier contact
		.value("GCPBarrier", ContactFormulation::GCPBarrier)    //placeholder for GCP-style barrier contact
		.value("OGCBarrier", ContactFormulation::OGCBarrier)    //placeholder for OGC-style barrier contact
		;
...
//        LTG readout functions:
    ...
    py::class_<PyGeneralContact>(m, "GeneralContact")
        ...
        .def_property("contactFormulation", &PyGeneralContact::GetContactFormulation, &PyGeneralContact::SetContactFormulation)
        ...
        .def_property("barrierActivationDistance", &PyGeneralContact::GetBarrierActivationDistance, &PyGeneralContact::SetBarrierActivationDistance)
        .def_property("barrierStiffness", &PyGeneralContact::GetBarrierStiffness, &PyGeneralContact::SetBarrierStiffness)
        .def_property("barrierMinimumDistance", &PyGeneralContact::GetBarrierMinimumDistance, &PyGeneralContact::SetBarrierMinimumDistance)
        .def_property("gcpBarrierPower", &PyGeneralContact::GetGCPBarrierPower, &PyGeneralContact::SetGCPBarrierPower)
        .def_property("gcpAlphaT", &PyGeneralContact::GetGCPAlphaT, &PyGeneralContact::SetGCPAlphaT)
        .def_property("gcpBetaT", &PyGeneralContact::GetGCPBetaT, &PyGeneralContact::SetGCPBetaT)
        .def_property("gcpAlphaN", &PyGeneralContact::GetGCPAlphaN, &PyGeneralContact::SetGCPAlphaN)
        .def_property("gcpBetaN", &PyGeneralContact::GetGCPBetaN, &PyGeneralContact::SetGCPBetaN)
        .def_property("gcpInteriorEpsilon", &PyGeneralContact::GetGCPInteriorEpsilon, &PyGeneralContact::SetGCPInteriorEpsilon)
        .def_property("enablePotentialFriction", &PyGeneralContact::GetEnablePotentialFriction, &PyGeneralContact::SetEnablePotentialFriction)
        .def_property("useNonlinearCCDStepFilter", &PyGeneralContact::GetUseNonlinearCCDStepFilter, &PyGeneralContact::SetUseNonlinearCCDStepFilter)
        .def_property("ccdTolerance", &PyGeneralContact::GetCCDTolerance, &PyGeneralContact::SetCCDTolerance)
        .def_property("useGaussNewtonHessian", &PyGeneralContact::GetUseGaussNewtonHessian, &PyGeneralContact::SetUseGaussNewtonHessian)
        ...
        .def("AddRigidBodySurfaceMesh", &PyGeneralContact::PyAddRigidBodySurfaceMesh, "add rigid surface mesh data attached to a rigidBodyMarker for potential-based contact formulations; pointList contains local vertex coordinates relative to the marker frame and triangleList contains the associated connectivity; returns local mesh index in the internal rigid-body surface mesh list", py::arg("rigidBodyMarkerIndex"), py::arg("pointList"), py::arg("triangleList"), py::arg("frictionMaterialIndex") = 0, py::arg("staticMesh") = false)
        ...
        .def("GetRigidBodySurfaceMesh", &PyGeneralContact::PyGetRigidBodySurfaceMesh, "Get dictionary with rigid surface mesh data for potential-based contact, including local and world-space vertices, triangle connectivity, marker kinematics and optionally per-vertex Jacobians", py::arg("localIndex"), py::arg("includeJacobians") = false)
        ...
        .def("UpdateRigidBodySurfaceMeshes", &PyGeneralContact::PyUpdateRigidBodySurfaceMeshes, "Update world-space kinematics for rigid surface meshes used by potential-based contact formulations; this is primarily intended as a debug and validation path during week-2 integration", py::arg("mainSystem"), py::arg("computeJacobians") = true)
